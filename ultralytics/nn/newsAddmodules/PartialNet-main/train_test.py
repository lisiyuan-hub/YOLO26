    ...
    if args.measure_latency:
        ...
        for idx, (images, _) in enumerate(dm.test_dataloader()):
            ...
            if torch.cuda.is_available():
                _throughput, _latency = measure_latency(images, model, GPU=True)
            exit()
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--pl_ckpt_2_torch_pth", action="store_true", help="convert pl .ckpt file to torch .pth file, and then exit"
    )
