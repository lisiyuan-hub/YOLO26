...
def build_transform(is_train, args, image_size):
    ...
    if is_train:
        ...
        if not resize_im:
            # replace RandomResizedCropAndInterpolation with RandomCrop according to cifar
    ...
    if image_size == 32:
        ...
        t.append(imagenet_normalization())
