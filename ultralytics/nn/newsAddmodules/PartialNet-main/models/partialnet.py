    ...
    def __init__(
        ...
        if self.auto_div:
            self.spatial_mixing = DGConv2d(
                ...
                bias=False,
                sort=False,
                u_regular=self.u_regular,
                l_gate=self.l_gate,
                index_div=self.index_div,
                n_div=self.n_div,
                print_n_div=self.print_n_div,
        ...
        **kwargs,
        ...
        if self.fork_feat:
            ...
            self.avgpool_pre_head = nn.Sequential(
                nn.AdaptiveAvgPool2d(1), nn.Conv2d(self.num_features, feature_dim, 1, bias=False), act_layer()
            )
