...
def make_blocks(
    block_fn: BasicBlock | Bottleneck,
    channels: tuple[int, ...],
...
def ecaresnetlight(pretrained: bool = False, **kwargs) -> ResNet:
    ...
    model_args = dict(
        block=Bottleneck, layers=(1, 1, 11, 3), stem_width=32, avg_down=True, block_args=dict(attn_layer="eca")
    )
...
def seresnext50_32x4d(pretrained: bool = False, **kwargs) -> ResNet:
    model_args = dict(
        block=Bottleneck, layers=(3, 4, 6, 3), cardinality=32, base_width=4, block_args=dict(attn_layer="se")
    )
...
def seresnext101_32x4d(pretrained: bool = False, **kwargs) -> ResNet:
    model_args = dict(
        block=Bottleneck, layers=(3, 4, 23, 3), cardinality=32, base_width=4, block_args=dict(attn_layer="se")
    )
...
def seresnext101_32x8d(pretrained: bool = False, **kwargs) -> ResNet:
    model_args = dict(
        block=Bottleneck, layers=(3, 4, 23, 3), cardinality=32, base_width=8, block_args=dict(attn_layer="se")
    )
...
def seresnext101_64x4d(pretrained: bool = False, **kwargs) -> ResNet:
    model_args = dict(
        block=Bottleneck, layers=(3, 4, 23, 3), cardinality=64, base_width=4, block_args=dict(attn_layer="se")
    )
...
def resnetblur50d(pretrained: bool = False, **kwargs) -> ResNet:
    ...
    model_args = dict(
        block=Bottleneck, layers=(3, 4, 6, 3), aa_layer=BlurPool2d, stem_width=32, stem_type="deep", avg_down=True
    )
...
def resnetblur101d(pretrained: bool = False, **kwargs) -> ResNet:
    ...
    model_args = dict(
        block=Bottleneck, layers=(3, 4, 23, 3), aa_layer=BlurPool2d, stem_width=32, stem_type="deep", avg_down=True
    )
...
def resnetaa50d(pretrained: bool = False, **kwargs) -> ResNet:
    ...
    model_args = dict(
        block=Bottleneck, layers=(3, 4, 6, 3), aa_layer=nn.AvgPool2d, stem_width=32, stem_type="deep", avg_down=True
    )
...
def resnetaa101d(pretrained: bool = False, **kwargs) -> ResNet:
    ...
    model_args = dict(
        block=Bottleneck, layers=(3, 4, 23, 3), aa_layer=nn.AvgPool2d, stem_width=32, stem_type="deep", avg_down=True
    )
