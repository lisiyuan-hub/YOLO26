...
if __name__ == "__main__":
    # 列出待获取数据内容的文件位置
    result_dict = {
        "exp1": r"C:\software\mydemo\yolo_demo\CSDN\YOLOv26_AIguai\runs\26train\exp\results.csv",
        "exp2": r"C:\software\mydemo\yolo_demo\CSDN\YOLOv26_AIguai\runs\26train\exp2\results.csv",
        "exp3": r"C:\software\mydemo\yolo_demo\CSDN\YOLOv26_AIguai\runs\26train\exp3\results.csv",
        "exp4": r"C:\software\mydemo\yolo_demo\CSDN\YOLOv26_AIguai\runs\26train\exp4\results.csv",
    }
