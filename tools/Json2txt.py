...
def convert_via_to_yolo(json_path, output_dir, img_w=640, img_h=640):
    """
    针对 Br35HDet VIA 格式的转换器
    支持 Polygon 和 Ellipse 形状自动转为 YOLO 矩形框
    """
...
convert_via_to_yolo(r"E:\Deeplearning\Datasets\Br35HDet\Br35HDet\annotations_val.json", r"E:\Deeplearning\Datasets\Br35HDet\Br35HDet\val\labels", img_w=640, img_h=640)